...
def build_orisun_pid(data, source):
        """Build orisun pid from record."""
        assert 'id' in data
        # assert (
...
def orisun_pid_minter(record_uuid, data, source):
    ...
    pid_value = build_orisun_pid(data, source)
    provider = SourcesPidProvider.create(
