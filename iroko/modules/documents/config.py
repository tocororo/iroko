...
RECORDS_REST_ENDPOINTS = {
    'recid': dict(
        ...
        search_type=None,
        record_serializers={
            'application/json': ('documents.serializers'
                                 ':json_v1_response'),
        },
        search_serializers={
            'application/json': ('documents.serializers'
        ...
        record_loaders={
            'application/json': ('documents.loaders'
                                 ':json_v1'),
        },
        list_route='/documents/',
        item_route='/documents/<pid(recid):pid_value>',
