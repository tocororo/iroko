...
APP_ALLOWED_HOSTS = ['iroko.tocororo.cu', 'localhost', '127.0.0.1', '10.80.4.34', '10.2.83.193',
                     '10.2.83.159',
                     '10.2.83.160', '192.168.1.100']
...
# CORS_ORIGINS = ['https://localhost:5000','https://localhost:4200', 'http://10.2.83.101:4200/',
# 'https://10.2.83.101:4200/']
# CORS_RESOURCES = r'/api/*'
# CORS_SEND_WILDCARD = True
# CORS_SUPPORTS_CREDENTIALS=True
# CORS_EXPOSE_HEADERS = [u'ETag', u'Link', u'X-RateLimit-Limit', u'X-RateLimit-Remaining',
# u'X-RateLimit-Reset', u'Content-Type']
