...
var JournalResolver = /** @class */ /*@__PURE__*/ (function () {
    ...
    JournalResolver.prototype.resolve = function (route, state) {
        ...
        return this.service.getJournalsById(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (node) {
            if (node) {
                return node;
            }
            else {
...
/* harmony import */ var _journal_view_journal_view_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./journal-view/journal-view.component */ "./src/irokoui/journal/journal-view/journal-view.component.ts");
/* harmony import */ var _journal_resolver__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./journal-resolver */ "./src/irokoui/journal/journal-resolver.ts");
/* harmony import */ var _journal_journal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./journal/journal.component */ "./src/irokoui/journal/journal/journal.component.ts");
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: ':id',
                component: _journal_view_journal_view_component__WEBPACK_IMPORTED_MODULE_0__["JournalViewComponent"],
                resolve: {
                    journal: _journal_resolver__WEBPACK_IMPORTED_MODULE_1__["JournalResolver"]
                }
            }
        ]
    }
];
var JournalRoutingModule = /** @class */ /*@__PURE__*/ (function () {
 ...
 * tslint:disable
 */
/** PURE_IMPORTS_START _journal_view.component.scss.shim.ngstyle,_angular_core,_journal_view.component,_angular_router,_.._core_metadata.service PURE_IMPORTS_END */
/** PURE_IMPORTS_START _journal_view.component.scss.shim.ngstyle,_angular_core,_journal_view.component,_angular_router,_.._core_metadata.service PURE_IMPORTS_END */
...
var RenderType_JournalViewComponent = /*@__PURE__*/ /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({ encapsulation: 0, styles: styles_JournalViewComponent, data: {} });
...
var JournalViewComponentNgFactory = /*@__PURE__*/ /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("toco-journal-view", _journal_view_component__WEBPACK_IMPORTED_MODULE_2__["JournalViewComponent"], View_JournalViewComponent_Host_0, {}, {}, []);
...
var JournalViewComponent = /** @class */ /*@__PURE__*/ (function () {
 ...
 * tslint:disable
 */
/** PURE_IMPORTS_START _angular_core,_journal.module,_.._.._node_modules__angular_material_tooltip_typings_index.ngfactory,_.._.._node_modules__angular_material_dialog_typings_index.ngfactory,_.._.._node_modules__angular_material_snack_bar_typings_index.ngfactory,_.._.._node_modules__angular_router_router.ngfactory,_journal_journal.component.ngfactory,_journal_view_journal_view.component.ngfactory,_angular_common,_angular_cdk_overlay,_angular_cdk_bidi,_angular_material_menu,_angular_cdk_observers,_angular_material_tooltip,_angular_material_core,_angular_material_dialog,_angular_material_select,_angular_material_paginator,_angular_platform_browser,_angular_material_autocomplete,_angular_flex_layout_core,_angular_forms,_journal.service,_angular_common_http,_journal_resolver,_angular_router,_angular_cdk_platform,_angular_material_button,_angular_material_button_toggle,_angular_cdk_portal,_angular_cdk_scrolling,_angular_material_toolbar,_angular_cdk_a11y,_angular_material_icon,_angular_material_card,_angular_cdk_text_field,_angular_material_form_field,_angular_material_input,_angular_material_checkbox,_angular_material_grid_list,_angular_material_snack_bar,_angular_material_progress_bar,_angular_material_progress_spinner,_angular_material_sidenav,_angular_material_tabs,_angular_material_chips,_angular_cdk_table,_angular_material_table,_angular_material_slide_toggle,_shared_material.module,_angular_flex_layout_flex,_angular_flex_layout_extended,_angular_flex_layout_grid,_angular_flex_layout,_shared_shared.module,_journal_routing.module,_angular_cdk_keycodes,_journal_journal.component,_journal_view_journal_view.component PURE_IMPORTS_END */
/** PURE_IMPORTS_START _angular_core,_journal.module,_.._.._node_modules__angular_material_tooltip_typings_index.ngfactory,_.._.._node_modules__angular_material_dialog_typings_index.ngfactory,_.._.._node_modules__angular_material_snack_bar_typings_index.ngfactory,_.._.._node_modules__angular_router_router.ngfactory,_journal_journal.component.ngfactory,_journal_view_journal_view.component.ngfactory,_angular_common,_angular_cdk_overlay,_angular_cdk_bidi,_angular_material_menu,_angular_cdk_observers,_angular_material_tooltip,_angular_material_core,_angular_material_dialog,_angular_material_select,_angular_material_paginator,_angular_platform_browser,_angular_material_autocomplete,_angular_flex_layout_core,_angular_forms,_journal.service,_angular_common_http,_journal_resolver,_angular_router,_angular_cdk_platform,_angular_material_button,_angular_material_button_toggle,_angular_cdk_portal,_angular_cdk_scrolling,_angular_material_toolbar,_angular_cdk_a11y,_angular_material_icon,_angular_material_card,_angular_cdk_text_field,_angular_material_form_field,_angular_material_input,_angular_material_checkbox,_angular_material_grid_list,_angular_material_snack_bar,_angular_material_progress_bar,_angular_material_progress_spinner,_angular_material_sidenav,_angular_material_tabs,_angular_material_chips,_angular_cdk_table,_angular_material_table,_angular_material_slide_toggle,_shared_material.module,_angular_flex_layout_flex,_angular_flex_layout_extended,_angular_flex_layout_grid,_angular_flex_layout,_shared_shared.module,_journal_routing.module,_angular_cdk_keycodes,_journal_journal.component,_journal_view_journal_view.component PURE_IMPORTS_END */
...
var JournalModule = /** @class */ /*@__PURE__*/ (function () {
...
var JournalService = /** @class */ /*@__PURE__*/ (function () {
    function JournalService(http) {
        this.http = http;
    }
    JournalService.prototype.getJournalsById = function (id) {
        var req = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apisEndpoints.irokoCatalog + '/sources/' + id;
 ...
 * tslint:disable
 */
/** PURE_IMPORTS_START _journal.component.scss.shim.ngstyle,_angular_core,_angular_router,_journal.component PURE_IMPORTS_END */
/** PURE_IMPORTS_START _journal.component.scss.shim.ngstyle,_angular_core,_angular_router,_journal.component PURE_IMPORTS_END */
...
var RenderType_JournalComponent = /*@__PURE__*/ /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({ encapsulation: 0, styles: styles_JournalComponent, data: {} });
...
var JournalComponentNgFactory = /*@__PURE__*/ /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("toco-journal", _journal_component__WEBPACK_IMPORTED_MODULE_3__["JournalComponent"], View_JournalComponent_Host_0, {}, {}, []);
...
var JournalComponent = /** @class */ /*@__PURE__*/ (function () {
